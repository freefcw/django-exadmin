...
class SelectMultipleTransfer(forms.SelectMultiple):
    ...
    @property
    def media(self):
        return forms.Media(js=[static("exadmin/js/widgets/select-transfer.js"),], \
            css={'screen': [static('exadmin/css/select-transfer.css'),]})
...
exadmin.site.register_plugin(M2MSelectPlugin, ModelFormAdminView)
