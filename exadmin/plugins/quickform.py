...
from exadmin.util import get_model_from_relation, static
...
class RelatedFieldWidgetWrapper(forms.Widget):
    ...
    def media(self):
        ...
        media.add_js([static('exadmin/js/quick-form.js'),])
        media.add_css({'screen': [static('exadmin/css/bootstrap-modal.css')]})
        return media
